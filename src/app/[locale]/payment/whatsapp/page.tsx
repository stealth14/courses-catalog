...
export default async function WhatsappPaymentPage({
  ...
  const waLink = `https://wa.me/${whatsapp.phone}?text=${encodeURIComponent(template)}`;
    ...
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[#1DA851] px-5 text-sm font-medium text-white transition-colors hover:bg-[#128C7E]"
        >
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
